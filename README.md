# Global-Airbnb-Performance-Dashboard
   ...
   A dynamic interactive data visualization tool built to explore Airbnb performance data on listings, cities, property types, reviews       and hosts.

➼ Purpose:

   To provide a data-driven overview of the Airbnb ecosystem across major global markets, enabling stakeholders to identify growth            patterns, evaluate competitive pricing, and assess host reliability and guest satisfaction trends.
